...
path_data_to_be_merged = 'data_to_be_merged/'

try:
    files_list = [f for f in os.listdir(path_data_to_be_merged) if os.path.isfile(os.path.join(path_data_to_be_merged, f))]
    ...
    for col in col_names:
        for row in row_names:
            ...
            new_col = re.sub('[^.,a-zA-Z0-9]+', '', new_col)
